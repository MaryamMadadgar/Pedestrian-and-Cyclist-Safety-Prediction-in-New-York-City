...
Longitude = st.number_input("Enter Longitude (3 decimal places):",min_value=-74.255, max_value=-73.700, format="%.3f")
Latitude = st.number_input("Enter Latitude (3 Decimal Places):",min_value=40.495, max_value=40.915, format="%.3f")
