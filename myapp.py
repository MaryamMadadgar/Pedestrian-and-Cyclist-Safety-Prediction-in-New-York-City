...
st.title("This Application Shows The Risk of Your Location in New York City,for more informations please see this link: https://github.com/MaryamMadadgar/Pedestrian-and-Cyclist-Safety-Prediction-in-New-York-City-App/blob/main/README.md")
